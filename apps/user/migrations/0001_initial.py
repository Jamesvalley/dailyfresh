    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.CharField(verbose_name='收件人地址', max_length=255)),
                ('zip_code', models.CharField(verbose_name='邮编', max_length=8, null=True)),
                ('phone', models.CharField(verbose_name='联系电话', max_length=11)),
                ('is_default', models.BooleanField(verbose_name='是默认的吗？', default=False)),
