    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(verbose_name='商品类型封面图', upload_to='type')),
            ],
            options={
                'verbose_name': '商品种类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('display_type', models.SmallIntegerField(verbose_name='商品显示类型', default=1, choices=[(0, '标题'), (1, '图片')])),
